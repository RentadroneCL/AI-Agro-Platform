<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl">
        {{ __('Welcome to your droneraising application!') }}
    </div>

    <div class="mt-6 text-gray-500">
        <p class="mb-1">{{ __('It looks like the first time you here!') }}</p>

        <p class="mb-4">{{ __('Configure a new site to keep track of all of your inspections.') }}</p>

        <x-button-link href="{{ route('site.create') }}">
            {{ __('Create new site') }}
        </x-button-link>
    </div>
</div>
