...
class ContactFormDialogModal extends Component
{
    /**
     * Toggle variable.
     *
     * @var bool $confirmingContactFormSubmission
     */
    public bool $confirmingContactFormSubmission = false;
    ...
    public function sendMessage(): void
    {
        ...
        session()->flash('status', __('Notification sent!'));
        ...
        $this->confirmingContactFormSubmission = false;
    }
    ...
    {
        return view('livewire.contact-form-dialog-modal');
    }
}
